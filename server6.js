          ...
          <div class="card-body text-center">
            ...
            <div class="mt-4">
              ...
              <div class="list-group">
                <a href="/api/health" class="list-group-item list-group-item-action">GET /api/health</a>
                <a href="/api/voyages" class="list-group-item list-group-item-action">GET /api/voyages</a>
              </div>
            </div>
